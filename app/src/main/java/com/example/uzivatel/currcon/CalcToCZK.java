...
public class CalcToCZK extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calc_to_czk);
 ...
 /*
    ...
    public void calc(View v) {
        String inputString = ((EditText)findViewById(R.id.etAmountInput2)).getText().toString();
        if (inputString.equalsIgnoreCase("")) {
            inputString="0";
        }
        int amountinput2=Integer.parseInt(inputString);
        int menaIndex = (int)spinner.getSelectedItemId();

        Mena mena = meny.get(menaIndex);

        double result = amountinput2 * mena.getKurz() / mena.getMnozstvo() ;

        TextView tvResult = (TextView) findViewById(R.id.tvResult);
        tvResult.setText(String.format("%,2f",result)+" CZK");
        //tvResult.setText(Double.toString(result)+" CZK");
        //tvResult.setText(Integer.toString(amountinput2)+" CZK");
